...
Feature-author contracts remain under `packages/api/src/`. The workspace runtime provides accepted manifest generations, and sibling facet registries own live contributed members.
