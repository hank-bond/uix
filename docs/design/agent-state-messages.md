...
- **app continuation** — the same substrate-owned queue as followUp; "run finished → substrate decides the next invocation" is a substrate decision and composes with the fan-out direction, where a pi-side queue wouldn't.
