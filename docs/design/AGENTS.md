...
- **[uix-core-composition](./uix-core-composition.md)** _(exploring, explanation)._ Exploring Pi installation from direct Workspace and Agent feature factories, including reload and typed communication.
