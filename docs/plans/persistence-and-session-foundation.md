...
2. Derive the selected branch's named-turn-state-cell projection and run their existing restore callbacks on startup/reload/session activation; add preview only with the later navigation UI.
