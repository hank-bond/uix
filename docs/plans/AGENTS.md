...
- **[resource-routes](./resource-routes.md)** _(active)_ — Make resource locations route-based: feature authors declare a resource route and origin policy, while the substrate owns URL generation/parsing across Electron and future hosted transports.
