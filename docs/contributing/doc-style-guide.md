...
kind: reference
read_when: "Read before writing or reviewing documentation prose or Markdown, or before adding a style rule."
---
...
Prose follows the direction of Simplified Technical English (STE), but does not implement it concretely. Prettier enforces formatting. Vale enforces the mechanical prose rules we encode.
