...
**Rejected:** sparse overrides resolved against live defaults on every read, and retaining default provenance beside every materialized value. Also rejected: silently rewriting existing values when contributed defaults change.
