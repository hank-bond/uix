---
summary: "The base read/write/edit tools become anchor-based so files and canvases share one §-wire editing vocabulary. The anchor core (AnchoredDocument, pool, wire) is shared substrate. Anchored file tools remain feature-owned contributions over a per-feature buffer."
kind: explanation
status: accepted
---
