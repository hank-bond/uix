...
- **[concepts](./concepts.md)** _(active)_ — Canonical UIX concept vocabulary: feature, facet, installer, driver, hook, contribution point, contribution, capability handle, registry, coordinator, assembler, reload reconciliation, and state-message-local terms, with boundaries from pi extension vocabulary.
