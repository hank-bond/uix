...
- **[conventions](./conventions.md)** _(active)_ — Code conventions for the cockpit — lifetimes, naming (including the verb taxonomy), capability handles, comments, module exports, validation, logging, imports, lifecycle helpers; most are main-process, but naming and comments apply to all UIX code.
