...
- **[contributing](./contributing.md)** _(how-to)._ Conventions authoring covers formats, quality tests, structural checks, and adoption with explicitly deferred migrations. _Read before proposing changes to any conventions document._
