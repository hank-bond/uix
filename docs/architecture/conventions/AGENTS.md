...
- **[naming-and-comments](./naming-and-comments.md)** _(active, reference)_ — UIX code expresses stable domain contracts through canonical identifier grammar and comment rules: JSDoc coverage and form, why-comments allocated by risk, and no planning artifacts. _Read before introducing or renaming symbols, recurring vocabulary, projections, predicates, or explanatory comments._
