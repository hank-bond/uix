...
- **[lifetimes](./lifetimes.md)** _(reference)._ Exclusive cleanup belongs to Disposable lifetimes, while independently retained shared objects use supervisor-issued guards. _Read before attaching callbacks, listeners, IPC, protocols, timers, or any other behavior that requires cleanup._
