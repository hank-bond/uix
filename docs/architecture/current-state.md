...
This document records the implemented system at HEAD. The root [`AGENTS.md`](../../AGENTS.md) states the project model. The shipped reference lives under [`AGENTS.md`](../../src/docs/AGENTS.md).
