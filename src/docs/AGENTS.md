...
- **[add-a-surface](./add-a-surface.md)** _(how-to)._ Add a surface to a feature: author an entry with defineSurface, declare its channel namespaces, and mount it in the workspace. _Read when adding a surface to a feature, or when asked to add a surface._
