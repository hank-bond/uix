...
- **[code-proximate-documentation](./code-proximate-documentation.md)** _(active)._ Establish code-proximate agent documentation in four units: placement and comment rules, generated source indexes, one representative source-boundary migration, then ongoing ownership-based migration without duplicate prose inventories.
...
- **[file-summary-migration](./file-summary-migration.md)** _(active)._ Migrate every production source header to the summary-plus-elaboration model with controlled vocabulary, add missing headers and AGENTS.md overviews, and align AGENTS.md summaries.
