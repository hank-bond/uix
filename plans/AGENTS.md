...
- **[code-proximate-documentation](./code-proximate-documentation.md)** _(active)._ Establish code-proximate agent documentation in four units: placement and comment rules, generated source indexes, representative source-boundary migration, and ongoing ownership-based migration without duplicate prose inventories.
