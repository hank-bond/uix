...
- **[substrate-scoped-channel-contracts](./substrate-scoped-channel-contracts.md)** Move backend channel ownership into substrate-established feature scope, while surfaces declare every consumed namespace in one validated client map.
