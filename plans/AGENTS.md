...
- **[substrate-scoped-channel-contracts](./substrate-scoped-channel-contracts.md)** Move channel ownership out of authored contracts and into substrate-established feature scope, while making every cross-feature client target explicit.
