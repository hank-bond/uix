...
- **[request-completion-and-settings-persistence](./request-completion-and-settings-persistence.md)** Rebase settings persistence onto worktree-owned immediate writes before resuming this deferred request-completion plan.
...
- **[session-worktrees-and-turn-checkpoints](./session-worktrees-and-turn-checkpoints.md)** Rebase workspace-file state implementation onto branch-owned worktrees, pre-run and post-turn checkpoints, opaque IDs, and explicit session deletion.
