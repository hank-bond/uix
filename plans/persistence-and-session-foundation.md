...
**Build.** In UIX submit prep, append before calling `session.prompt(text)`, once the latest canvas writebacks have updated current content and any user-text-dependent context/reminder prep has finished:
