...
2. _Landed 2026-07-19:_ serialized reload commits current active feature state after restoration settles, activates replacements, reloads initialized Pi resources, restores the selected branch through a turn-state registry snapshot, and publishes `surfaces_changed` after restoration settles; add preview only with the later navigation UI.
