...
> **Landed.** The settings substrate ships and is documented in [`add-settings-to-a-feature.md`](../../src/docs/add-settings-to-a-feature.md). Future tracked document publication remains in [`backlog.md`](../backlog.md).
