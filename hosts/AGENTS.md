...
- **[electron/](./electron/AGENTS.md)** Electron composition root and adapters: native chrome, IPC, protocol, windows, and client bootstraps over the shared runtime and clients. _Writing Electron-specific host code, or deciding that a capability is Electron packaging rather than shared substrate._
